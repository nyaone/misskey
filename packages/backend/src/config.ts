...
export type Config = {
	...
	mediaProxySignatureKey: string | null;
...
export function loadConfig(): Config {
	...
	return {
		...
		mediaProxySignatureKey: (!!config.mediaProxySignatureKey && config.mediaProxySignatureKey !== "") ? config.mediaProxySignatureKey : null,
