	...
	<div :class="[$style.main, $style.panel]">
		...
		<div :class="$style.mainFg">
			...
			<div class="_gaps_s" :class="$style.mainActions">
				...
				<MkButton v-if="instance.disableRegistration" :class="$style.mainAction" full rounded type="a" target="_blank" rel="noopener" href="https://join.nya.one">获得邀请码</MkButton>
